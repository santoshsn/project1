...
class RegistersControllerTest < ActionController::TestCase
  ...
  test "should create register" do
    assert_difference('Register.count') do
      post :create, register: { address: @register.address, email: @register.email, firstname: @register.firstname, lastname: @register.lastname, phone: @register.phone }
    end
  ...
  test "should update register" do
    put :update, id: @register, register: { address: @register.address, email: @register.email, firstname: @register.firstname, lastname: @register.lastname, phone: @register.phone }
    assert_redirected_to register_path(assigns(:register))
  end
